  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24" ref={containerRef}>
      ...
      <Image src={EmojiImage} alt="emoji" className="absolute -top-[120px] right-[calc(100%+30px)]" />
        ...
        Experience premium grooming like never before. Book your appointment at Big Boss Salon today and unlock exclusive plans, priority service, and unbeatable style.</p>
        <form className="mt-10 flex flex-col gap-2.5 max-w-sm mx-auto sm:flex-row">
          <input type="email" placeholder="info@bigboss.com" className="h-12 bg-white/20 rounded-lg px-5 font-medium placeholder:text-[#9CA3AF] sm:flex-1"/>
